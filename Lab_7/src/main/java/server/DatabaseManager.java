...
public class DatabaseManager {
    ...
    /**
     * Deletes all flats owned by requesterLogin that are "less than" the given flat
     * using the same comparison as Flat.compareTo: area, then numberOfRooms, then name.
     * Returns list of deleted IDs to synchronize in-memory collection.
     */
